...
public class ResultsFragment extends BaseFragment {
    ...
    private void makeResults() {
        ...
        String cost = decimalFormat.format(PreferenceDoubles.INSTANCE.getDouble(shared, "cost", 0.00));
        String subtotal = decimalFormat.format(PreferenceDoubles.INSTANCE.getDouble(shared, "subtotal", 0.00));
